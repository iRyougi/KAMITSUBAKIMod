...
namespace KAMITSUBAKIMod.Runtime
{
    public class BookScanner : MonoBehaviour
    {
        ...
        [Serializable] class Book { [SerializeField] public List<Grid> importGridList; }
        [Serializable] class Grid { [SerializeField] public List<Row> rows; }
        [Serializable] class Row { [SerializeField] public int rowIndex; [SerializeField] public List<string> strings; }
