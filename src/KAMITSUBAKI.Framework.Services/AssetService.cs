...
using static UnityEngine.ImageConversion; // ¡û for Texture2D.LoadImage
...
namespace KAMITSUBAKI.Framework.Services
{
    public class AssetService : IAssetService
    {
        ...
        public static bool VerboseMisses = false; // ÓÉ FrameworkPlugin ÅäÖÃ¿ØÖÆ
        ...
        public bool RemoveCache(string virtualPath)
        {
            ...
            foreach (var k in _cache.Keys)
            {
                ...
                if (string.Equals(vp, virtualPath, System.StringComparison.OrdinalIgnoreCase))
                    removed.Add(k);
            }
